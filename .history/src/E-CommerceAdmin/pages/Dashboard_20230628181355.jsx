...
const Dashboard = () => {
  ...
  const card = [
...

    {
      ...
      number: 100,
      icon: (
        <i className=" fa-solid fa-layer-gr text-2xl text-[#1b6975]"></i>
      ),
      bg: "#1b6975",
      link: "/Orders",
    },

    {
      ...
      number: 100,
      icon: (
        <i className=" fa-solid fa-envelope text-2xl text-[#659cca]"></i>
      ),
      bg: "#659cca",
      link: "/Orders",
    },

    {
      ...
      number: 100,
      icon: (
        <i className=" fa-solid fa-image text-2xl text-[#6bb07e]"></i>
      ),
      bg: "#6bb07e",
      link: "/Orders",
    },

    {
      ...
      number: 100,
      icon: (
        <i className=" fa-solid fa-ticket text-2xl text-[#944f81]"></i>
      ),
      bg: "#944f81 ",
      link: "/Orders",
    },
