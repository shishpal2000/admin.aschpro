      ...
      <section className="sectionCont">
          ...
          <div className="Left_Cont">
            ...
            <div className="right_Cont">
                ...
                <p> <span>4.3</span>  <span>77,509 Ratings & 6,081 Reviews</span> </p>
                <p> 26% off </p>
                <div>
                    <p>  <i className="fa-solid fa-indian-rupee-sign"></i>12,499 </p>
                    <p> <i className="fa-solid fa-indian-rupee-sign"></i> 16,488 </p>
                </div>

                <ul>
                    <li> 6 GB RAM | 128 GB ROM | Expandable Upto 256 GB
</li>
<li>16.51 cm (6.5 inch) Full HD+ Display
</li>
<li></li>
                </ul>
            </div>
