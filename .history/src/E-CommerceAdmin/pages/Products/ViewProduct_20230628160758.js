      ...
      <section className="sectionCont">
        <div className="Detail_Section">
          ...
          <div className="right_Cont">
            <p>realme Narzo 30 (Racing Silver, 128 GB) (6 GB RAM)</p>
            <p>
              {" "}
              <span>4.3</span> <span>77,509 Ratings & 6,081 Reviews</span>{" "}
            </p>
            <p> 26% off </p>
            <div>
              <p>
            ...
            <div>
                <p>Description</p> : <p>With the realme Narzo 30, make your mobile gaming experience smooth, lag-free, and immersive. This smartphone runs on the Helio G95 Gaming Processor for intense gaming, a 90 Hz Ultra-smooth Display for smooth scrolling, and a 5000 mAh Massive Battery for hours of gaming marathons</p>
            </div>
            <div>
            <p>Color :</p> <p>Red , Black</p>
            </div>
            <div>
            <p>Seller Name :</p> <p>Red , Black</p>
            </div>
            <div>
            <p>Color :</p> <p>Red , Black</p>
            </div>
