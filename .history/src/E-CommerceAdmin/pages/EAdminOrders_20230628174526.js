  ...
  const data = [
    {
      ...
      products : [
        ...
        {
          product : "OPPO A17k (Blue, 64 GB)  (3 GB RAM)" 
        },
      ]
      , 
      shippingAddress : "S/o Arun chaudhary village shekhpuri bhola road meerut 250502"
    }
  ]
              ...
              <tbody>
                {slicedData?.map((i, index) => (
                  <tr key={index}>
                    <td> #{index + 1} </td>
                    <td> {i.user} </td>
                    <td>  <i className="fa-solid fa-indian-rupee-sign"></i>{i.totalPrice} </td>
                    ...
                    <td> <i className="fa-solid fa-indian-rupee-sign"></i>{i.taxPrice} </td>
